...
<thead>
  ...
  <!-- kayıt edilen araçların  döngü şeklinde veri tabanına göndermek ve çağırmak için  kodlar -->
...
?>
  <tbody>
    <tr>
      ...
      <td><a href="duzenle.php?id=<?php echo $id ?>" ><button type="submit" class="btn  bg-primary">DÜZENLE</button></a></td>
      <td><a href="araccikis.php?id=<?php echo $id ?>" ><button type="submit" class="btn  bg-success">ARAÇ ÇIKIŞ</button></a></td>
      <td><a href="sil.php?id=<?php echo $id ?>"><button type="submit" class="btn btn-danger"><svg
